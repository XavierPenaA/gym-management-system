...
public class ControlEditarMaterial implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource()==vista.cambiarFechaButton){
            ...
            manejoPrincipal.getManejoGimnasio().gimnasios.get(indexGim).ubicaciones.get(indexUbi).equipos.get(indexEquipo).materiales.get(indexEditar).historialMantenimiento.add(dateProx);
