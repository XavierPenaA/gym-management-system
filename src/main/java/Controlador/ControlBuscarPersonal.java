...
public class ControlBuscarPersonal implements ActionListener {
    ...
    public ControlBuscarPersonal(){
        ...
        vista.eliminarSeleccionadoButton.addActionListener(this);
        actualizarComboBox();
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource()==vista.eliminarSeleccionadoButton) {
            Personal personalAEliminar = manejoPrincipal.getManejoPersonal().buscarPersonalPorCedula((String) vista.comboBoxUsuario.getSelectedItem());
            if (personalAEliminar != null) {
                String rutaFoto = personalAEliminar.getRutaFoto();
